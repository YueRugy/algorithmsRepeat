...
type UnionFind_UR_PC struct {
	parents []int
	rank    []int
}

func NewUnionFind_UR_PC(capacity int) *UnionFind_UR_PC {
	uf := &UnionFind_UR_PC{
...
func (uf *UnionFind_UR_PC) IsSame(v1, v2 int) bool {
...
func (uf *UnionFind_UR_PC) checkV(v int) bool {
...
func (uf *UnionFind_UR_PC) Find(v int) int {
	if uf.checkV(v) {
		return -1
	}
...
func (uf *UnionFind_UR_PC) Union(v1, v2 int) {
	if uf.checkV(v1) || uf.checkV(v2) || v1 == v2 {
		return
	}
